...
func configureFlags(api *operations.Tabletennis365ComFixturesAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.Tabletennis365ComFixturesAPI) http.Handler {
	...
	api.FixturesListFixturesHandler = fixtures.ListFixturesHandlerFunc(func(params fixtures.ListFixturesParams) middleware.Responder {
		...
		return fixtures.NewListFixturesOK().WithPayload(fs)
	})
